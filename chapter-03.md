...
1. Issue the following command to add the repository: For RHEL-based systems:
...
1. Let's start by issuing the following commands to install SNMP on our host. For RHEL-based systems:
